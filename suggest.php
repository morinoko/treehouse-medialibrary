...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!isset($error_message)) {
    ...
    $mail->Username = "feliceforby@gmail.com";
    //Password to use for SMTP authentication
    $mail->Password = "tjsmszwgocdlxcsu";
    //It's important not to use the submitter's address as the from address as it's forgery,
    //which will cause your messages to fail SPF checks.
    //Use an address in your own domain as the from address, put the submitter's address in a reply-to
    $mail->setFrom('felice@teamtreehouse.com', $name);
    $mail->addReplyTo($email, $name);
    $mail->addAddress('feliceforby@gmail.com', 'Felice Forby');
...
<div class="section page">
  <div class="wrapper">
    ...
    if (isset($_GET['status']) && $_GET['status'] == "thanks") {
      echo "<p>Thanks for the email! I will check out you suggestion shortly!</p>";
    } else { 
        if (isset($error_message)) {
          echo '<p class="message">' . $error_message . '</p>';
        } else {
          echo '<p>If you think there is something I&rsquo;m missing, let me know! Complete the form below.</p>';
        }
    ?>
